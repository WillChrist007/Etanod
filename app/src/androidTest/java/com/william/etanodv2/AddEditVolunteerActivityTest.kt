...
class AddEditVolunteerActivityTest {

    @Rule
    @JvmField
    var mActivityScenarioRule = ActivityScenarioRule(AddEditVolunteerActivity::class.java)

    @Test
    fun addEditVolunteerActivityTest() {
        ...
        val textInputEditText4 = onView(
            allOf(
                withId(R.id.et_waktu),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.layout_waktu),
                        0
                    ),
                    0
                )
        ...
        textInputEditText4.perform(scrollTo(), replaceText("12/30/2022"), closeSoftKeyboard())
